...
# Enhanced for complex query accuracy, tactical depth,
# fantasy intelligence, predictive analysis, and
# multi-format coverage (T10, T20, ODI, Test, Hundred)
# =====================================================
...
CRICKET_RULES = {
    ...
    "minimum_sample_size": {
        ...
        "fantasy_selection": {
            "matches": 3,
            "note":    "Minimum 3 recent matches needed for credible fantasy projection"
        },
        "predictive_analysis": {
            "innings": 15,
            "note":    "At least 15 innings required before predictive confidence is moderate"
        }
    },
    ...
    "match_formats": {
        "T10": {
            ...
            "powerplay_overs":    "1-2",
            "death_overs":        "8-10",
            "par_score_note":     "90 is par; 110+ is a dominant total"
        },
        "T20": {
            "max_overs":          20,
            "innings_per_match":  2,
        ...
        "THE_HUNDRED": {
            ...
            "powerplay_balls":    "1-25",
            "death_balls":        "76-100",
            "par_score_note":     "140 is par; 160+ is strong"
        }
    },
    ...
    "match_phases": {
        ...
        "T20": {
            "powerplay": {
                ...
                "strategic_insight":            "Getting 2+ wickets in powerplay gives bowling team a 25-30 run advantage on average. A powerplay score of 60+ is match-defining."
            },
            "middle_overs": {
                "start_over":             7,
                "end_over":               15,
                ...
                "strategic_insight":      "The quiet engine of high T20 totals — wicket preservation here is as valuable as boundary hitting."
            },
            "death_overs": {
                "start_over":                    16,
                "end_over":                      20,
                ...
                "strategic_insight":             "Death bowling economy below 9.0 is genuinely elite. The best death bowlers mix yorkers, slower balls, and bouncers reading the batter's trigger movements."
            }
        },
        "ODI": {
            "powerplay_1": {
    ...
    "batting_benchmarks": {
        "T20": {
            ...
            "middle_overs_sr": {
                "poor":      {"max": 100,              "label": "Anchor dragging the innings — cannot accelerate"},
                "average":   {"min": 100, "max": 119, "label": "Below par middle-overs contribution"},
                "good":      {"min": 120, "max": 134, "label": "Solid middle-overs batter"},
                "excellent": {"min": 135, "max": 149, "label": "Accelerates well in middle overs"},
                "elite":     {"min": 150,             "label": "Dominates the middle phase — rare skill"}
            },
            "six_rate": {
                "low":      {"max": 2.0,  "label": "Rarely clears the fence — ground-game player"},
                "medium":   {"min": 2.0,  "max": 4.0, "label": "Decent aerial game"},
                "high":     {"min": 4.0,  "max": 6.0, "label": "Strong power hitter"},
                "elite":    {"min": 6.0,              "label": "One of the most destructive hitters"}
            }
        },
        "ODI": {
            "strike_rate": {
            ...
            "powerplay_sr": {
                "poor":      {"max": 70,              "label": "Too slow — wasting powerplay field restrictions"},
                "average":   {"min": 70,  "max": 84, "label": "Conservative opener"},
                "good":      {"min": 85,  "max": 99, "label": "Good ODI powerplay batter"},
                "excellent": {"min": 100, "max": 114,"label": "Aggressive powerplay opener"},
                "elite":     {"min": 115,             "label": "Dominates in ODI powerplay"}
            },
            "death_sr": {
                "poor":      {"max": 95,              "label": "Struggles to accelerate in ODI death"},
                "average":   {"min": 95,  "max": 109,"label": "Average ODI finisher"},
                "good":      {"min": 110, "max": 124,"label": "Good ODI death batter"},
                "excellent": {"min": 125, "max": 144,"label": "Reliable ODI finisher"},
                "elite":     {"min": 145,             "label": "World-class ODI death specialist"}
            }
        },
        "TEST": {
            "strike_rate": {
    ...
    "bowling_benchmarks": {
        "T20": {
            ...
            "middle_overs_economy": {
                "elite":     {"max": 6.0,              "label": "Miserly in middle overs — hard to dislodge"},
                "excellent": {"min": 6.0,  "max": 7.0,"label": "Excellent middle-overs control"},
                "good":      {"min": 7.0,  "max": 7.99,"label": "Solid middle-overs bowler"},
                "average":   {"min": 8.0,  "max": 8.99,"label": "Can be scored off in middle overs"},
                "poor":      {"min": 9.0,              "label": "Expensive in middle overs — should not be used here"}
            }
        },
        "ODI": {
            "economy_rate": {
            ...
            "dot_ball_percentage": {
                "poor":      {"max": 35,              "label": "Insufficient pressure in ODIs"},
                "average":   {"min": 35, "max": 44,  "label": "Moderate ODI pressure"},
                "good":      {"min": 45, "max": 54,  "label": "Good dot-ball bowler"},
                "excellent": {"min": 55, "max": 64,  "label": "Very miserly in ODIs"},
                "elite":     {"min": 65,              "label": "Exceptional dot-ball machine in ODIs"}
            }
        },
        "TEST": {
            "economy_rate": {
            ...
            "dot_ball_percentage": {
                "poor":      {"max": 50,              "label": "Not enough dot balls in Tests"},
                "average":   {"min": 50, "max": 59,  "label": "Moderate Test pressure"},
                "good":      {"min": 60, "max": 69,  "label": "Good Test pressure bowler"},
                "excellent": {"min": 70, "max": 79,  "label": "Very economical Test bowler"},
                "elite":     {"min": 80,              "label": "Almost unplayable — elite Test control"}
            }
        }
    },
    ...
    "dismissal_types": {
        ...
        "Retired Out": {
            ...
            "common_causes":  ["tactical retirement in T20 to promote a hitter", "injury"],
    ...
    "bowling_types": {
        "pace": {
            ...
            "tactical_weapons": ["yorker", "bouncer", "outswing", "inswing", "reverse swing", "slower ball", "knuckleball", "off-cutter", "leg-cutter"],
        ...
        "spin": {
            ...
            "tactical_weapons": ["turn", "flight", "googly", "doosra", "arm ball", "carrom ball", "topspinner", "flipper", "slider"],
    ...
    "team_analysis": {
        "always_include": [
            "matches_played", "total_innings", "average_score", "run_rate",
            "highest_score", "lowest_score", "total_wickets_lost",
            "powerplay_average", "death_overs_average"
        ],
    ...
    "venue_analysis": {
        "always_include": [
            "matches_played", "average_first_innings_score",
            "average_second_innings_score", "average_winning_score",
        ...
        "venue_tiers": {
            "batting_venue_T20":  {"avg_score_threshold": 180, "insight": "Batter-friendly — prioritise hitters in selection"},
            "bowling_venue_T20":  {"avg_score_threshold": 145, "insight": "Bowler-friendly — prioritise wicket takers and economical bowlers"},
            "neutral_venue_T20":  {"avg_score_range": "155-175", "insight": "Balanced — all-round performance wins"}
        }
    },
    ...
    "partnership_rules": {
        ...
        "always_include": [
            "runs_added", "balls_faced_together",
            "run_rate_during_partnership", "boundaries_hit_together"
        ],
    ...
    "head_to_head_rules": {
        "minimum_balls": 12,
        "always_include": [
            "balls_faced", "runs_scored", "times_dismissed",
            "dot_balls_received", "boundaries_hit", "strike_rate_in_matchup"
        ],
        "insight_notes": [
            ...
            "When a bowler dismisses the same batter 3+ times, a psychological edge develops — captains exploit this in knockout matches",
            "A batter scoring SR >180 vs a bowler owns that matchup — captains avoid that combination",
            "The matchup history shapes field settings — high caught% shapes boundary fielder placement"
        ],
        "dismissal_pattern_notes": [
            ...
            "Bowled pattern suggests bowler has found the batter's gate — back-of-a-length or yorker line"
        ],
        "matchup_verdict_thresholds": {
            "batter_dominates":  "SR > 180 AND dismissals <= 1 per 15 balls",
            "even_contest":      "SR 120-180 AND dismissals every 10-20 balls",
            "bowler_controls":   "SR < 100 OR dismissals > 1 per 8 balls"
        }
    },
    ...
    "comparison_rules": [
        ...
        "When comparing, always state a clear winner — do not sit on the fence",
        "Phase-by-phase comparison is more revealing than overall career comparison",
        "For bowling comparisons: economy AND strike rate both matter — do not ignore one"
    ],
    ...
    "insight_rules": [
        ...
        "For leaderboard analysis: highlight the surprise entry and the most underrated performer",
        "For fantasy: always provide a clear captain, vice-captain, and differential recommendation",
        "For predictive questions: state probability qualitatively (likely / possible / unlikely) with justification",
        "Classify every player against archetype (Aggressor, Anchor, Finisher, Miser, Wicket-taker) where possible",
        "Identify INFLECTION POINTS in trend analysis — when did a player's form change and why?",
        "For consistency analysis: boom-or-bust classification must be explicit and justified with duck rate + 50+ rate"
    ],
    ...
    "match_situations": {
        ...
        "high_pressure_knockout": {
            "insight": "Knockout match pressure separates class from average. Players with superior clutch metrics (chase SR, death SR, knockout economy) are premium picks."
        },
        "powerplay_wicket_impact": {
            "insight": "Each wicket lost in the T20 powerplay costs a team approximately 8-12 runs compared to teams that don't lose the same wicket. The compounding effect of survival in powerplay is enormous."
        }
    },
    ...
    "all_rounder_thresholds": {
        "T20": {
            ...
            "elite_allrounder_profile": "SR > 140 AND economy < 8.0 AND 20+ wickets — genuinely match-winning in both roles",
            "batting_leaning_note":     "SR > 135 but economy > 9.5 = batting all-rounder, not a true dual threat",
            "bowling_leaning_note":     "Economy < 7.5 but SR < 115 = bowling all-rounder, batting is secondary"
        },
        "ODI": {
            ...
            "classification_note":         "ODI all-rounder must be a genuine top-6 bat AND a frontline bowling option"
        },
        "TEST": {
            ...
            "classification_note":         "Test all-rounder is one of the rarest skills in cricket — balance of 1000 runs and 50 wickets is the benchmark"
        }
    },
    ...
    "free_hit_rules": {
        ...
        "bowling_discipline_note": "A bowler who frequently bowls no-balls (generating free hits) is a liability — they give away scoring opportunities and lose mental edge."
    },
    ...
    "keeper_position_rules": {
        "keeper_up": {
            ...
            "impact":     "Limits batter's ability to leave crease — increases stumping risk. Psychologically restricts the batter. Cuts off the batter's ability to use feet to spinners.",
        ...
        "keeper_back": {
            ...
            "impact":     "More ground to cover for stumpings — batter can charge down the track more safely. Gives batter freedom to play late and leave.",
    ...
    "bowling_angle_rules": {
        "around_the_wicket": {
            ...
            "right_arm_to_right_batter":  "Angles into the body — strong LBW and bowled threat. Hard to play off side. Targets the corridor outside off stump to cramp the batter.",
    ...
    "scoring_zone_context": {
        ...
        "scoring_shot_rate": {
            "meaning": "Percentage of legal balls where the batter scores at least 1 run",
            "insight": "High scoring shot rate (>50%) indicates batter is hard to bowl to and rotates strike well; low rate (<35%) means the batter is surviving, not thriving"
        }
    },
    ...
    "consistency_metrics": {
        ...
        "consistency_thresholds": {
            ...
            "boom_or_bust":        "Duck rate > 15% AND 50+ rate > 20% — high peaks, high troughs",
            "consistent_anchor":   "Duck rate < 8% AND 20+ rate > 55% — dependable without being spectacular",
            "conversion_rate":     "50+ count / (30+ count) * 100 — shows ability to convert starts into big scores"
        },
        "milestone_counts": {
    ...
    "pressure_context": {
        "clutch_batting_situations": [
            ...
            "Chasing in a final with opposition bowling attack at full strength",
            "Entering with team score under 50 at fall of 3rd wicket in T20"
        ],
        "clutch_bowling_situations": [
            ...
            "Super over bowling",
            "Final over of a tight T20 chase with 10 runs to defend",
            "Powerplay with opposition openers set and scoring freely"
        ],
        "pressure_indicators": {
            "batting": "SR drops significantly vs career average = under pressure; chase SR vs setting SR deviation > 15% signals pressure sensitivity",
            "bowling": "Economy spikes in death overs vs overall economy = struggles under pressure; extra rate rises in final overs = discipline breakdown"
        },
        "clutch_performer_thresholds": {
            "batting": "Chase SR > setting SR by >10 points = genuine clutch batter",
            "bowling": "Death economy < overall economy = bowler performs better under pressure (rare and elite)"
        }
    },
    ...
    "recent_form_context": {
        ...
        "form_trend_insight": [
            ...
            "A player in poor form (last 5 below average) with strong career credentials = 'class is permanent' — likely to return",
            "A consistently poor performer across 30+ innings has a structural problem: technique, role mismatch, or selection error"
        ]
    },

    # =================================================
    # OVER-BY-OVER CONTEXT
    ...
    "over_context": {
        ...
        "RPO_deviation_insight": {
            "note": "If a bowler concedes significantly more or less than expected RPO in a given over-number across their career, it reveals a structural strength or weakness in that phase"
        }
    },
    ...
    "opponent_analysis_context": {
        ...
        "opposition_quality_note": "Performances against top-ranked teams carry more weight than vs lower-ranked opposition. Always contextualise opponent quality.",
        "flat_track_bully_note":   "A player with high SR only against bottom-ranked opponents is a flat-track bully — note if top-5 opponent SR drops >30 points vs career SR"
    },

    # =================================================
    # MILESTONE TRACKING CONTEXT
    # =================================================
    ...
    "performance_labels": {
        ...
        "fielding": {
            "elite":     "🔴 Elite Fielder — match-changing impact on most matches",
            "excellent": "🟠 Excellent Fielder — saves 8-10 runs per match on average",
            "good":      "🟡 Reliable Fielder — saves 4-6 runs per match",
            "average":   "🟢 Average Fielder — standard expectation",
            "poor":      "⚪ Liability — misfields and drops cost the team"
        }
    },
    ...
    # Dedicated section for fantasy-specific analysis
    # =================================================

    "fantasy_cricket_rules": {
        "captain_selection_criteria": [
            "Consistent recent form (last 5 matches above career average)",
            "Strong record at the specific venue",
            "Favourable matchup vs opponent's bowling attack",
            "High floor player — unlikely to score 0 — minimises risk",
            "High ceiling player — capable of match-winning score for multiplier benefit"
        ],
        "vice_captain_criteria": [
            "Second-best risk-reward after captain",
            "Complementary role — if captain is batter, consider vice-captain as all-rounder or key bowler",
            "In-form player with good matchup"
        ],
        "differential_pick_criteria": [
            "Overlooked player with good venue record",
            "Lower-order batter who can hit big if conditions allow",
            "Death bowler with low selection% but high recent economy"
        ],
        "avoid_criteria": [
            "Players in consecutive poor form (last 3 matches below average)",
            "Players with injury concerns or reduced role in team",
            "Batters with poor record at specific venue",
            "Bowlers with poor death economy at batting venues"
        ],
        "fantasy_points_estimate": {
            "T20_batting":  "runs + (4s * 1) + (6s * 2) + (50s * 8) + (100s * 16) + (ducks * -2) + (SR bonus for SR > 170: +6 pts)",
            "T20_bowling":  "wickets * 25 + (3wkt_haul * 4) + (5wkt_haul * 8) + (maidens * 4) + (economy bonus for < 5: +6 pts)",
            "note":         "Points systems vary by platform (Dream11, MPL, etc.) — use as an approximation only"
        },
        "venue_importance_note": "Venue batting/bowling average is the single most important contextual variable in fantasy selection — always check",
        "recent_form_weight":    "Recent form (last 5 matches) should be weighted 60%, career stats 40% for fantasy decisions",
        "opposition_weight":     "Opposition bowling quality is the second most important variable after venue"
    },

    # =================================================
    # PREDICTIVE ANALYSIS CONTEXT
    # Frameworks for projecting future performance
    # =================================================

    "predictive_context": {
        "prediction_confidence_levels": {
            "high_confidence":   "15+ innings, consistent pattern, stable role, good opponent record",
            "medium_confidence": "8-14 innings, some variance, role changes possible",
            "low_confidence":    "< 8 innings, new player, role uncertainty, inconsistent data"
        },
        "regression_to_mean": {
            "note":    "Players on exceptional hot streaks (>30% above career) typically regress. Players in slumps (>30% below career) often recover.",
            "caveat":  "Career-average regression is less reliable for young players still developing their peak level"
        },
        "form_weight": {
            "recent_5_matches":    "40% weight in prediction",
            "recent_10_matches":   "30% weight in prediction",
            "career_baseline":     "30% weight in prediction"
        },
        "key_risk_factors": [
            "Opponent bowling attack quality",
            "Venue conditions (batting paradise vs bowler's pitch)",
            "Player injury history or workload concerns",
            "Recent poor form streak (3+ consecutive failures)",
            "Format change (T20 to ODI or Test) — different skills required"
        ],
        "predictive_language": {
            "likely":   "Data strongly supports this outcome (>65% historical frequency)",
            "possible": "Data supports this outcome but with significant variance (35-65% frequency)",
            "unlikely": "Data suggests this outcome is against the trend (<35% frequency)"
        }
    },

    # =================================================
    # TOURNAMENT / COMPETITION BENCHMARKS
    # Context for specific tournaments
    # =================================================

    "tournament_benchmarks": {
        "IPL": {
            "format":               "T20",
            "avg_first_innings":    "165-175",
            "batting_par_sr":       135,
            "bowling_par_economy":  8.0,
            "powerplay_par":        "50-55 runs",
            "death_par_economy":    9.5,
            "note":                 "IPL is one of the highest-scoring T20 leagues globally — benchmarks are higher than international T20"
        },
        "BBL": {
            "format":               "T20",
            "avg_first_innings":    "155-170",
            "batting_par_sr":       130,
            "bowling_par_economy":  8.5,
            "note":                 "BBL pitches generally favour batters but are more balanced than IPL"
        },
        "PSL": {
            "format":               "T20",
            "avg_first_innings":    "150-165",
            "batting_par_sr":       128,
            "bowling_par_economy":  8.0,
            "note":                 "PSL pitches are often spin-friendly — economy benchmarks slightly lower"
        },
        "T20_World_Cup": {
            "format":               "T20I",
            "avg_first_innings":    "145-160",
            "batting_par_sr":       125,
            "bowling_par_economy":  7.5,
            "note":                 "World Cup pitches are often prepared to be balanced — both batting and bowling count"
        },
        "ODI_World_Cup": {
            "format":               "ODI",
            "avg_first_innings":    "280-300",
            "batting_par_sr":       90,
            "bowling_par_economy":  5.5,
            "note":                 "World Cup pitches favour batting in knockout rounds. 300+ is competitive."
        }
    },

    # =================================================
    # PSYCHOLOGICAL / TACTICAL WARFARE CONTEXT
    # =================================================

    "psychological_context": {
        "momentum_shifts": [
            "A batter being dismissed in the powerplay after scoring 30+ triggers a momentum shift — wicket worth 12 extra runs to bowling team",
            "Back-to-back sixes off a bowler force a captain change — the bowler losing confidence is a tactical victory",
            "A maiden over in death overs (very rare) is a complete psychological knockout for the batting side",
            "Run-out in the first 6 overs signals intent problems in the batting team — look for panic in subsequent scoring rate"
        ],
        "opposition_research": [
            "Identify the batter's most-faced delivery type (off-stump, body, short, full) and reverse it in planning",
            "Track timing of dismissals — early-spell or late-spell weakness changes the attack plan entirely",
            "Assess batter's response to pace vs spin transition — many players struggle when pace bowler is replaced by spinner mid-powerplay"
        ],
        "captain_decision_impact": [
            "Choosing to bat/bowl first: In T20, teams batting second win more (chasing advantage ~55%)",
            "Bowling change timing: introducing spinner in over 7 is the highest-impact decision in T20 captaincy",
            "Powerplay aggression setting: allowing a 70+ powerplay score is almost always unrecoverable",
            "Death over sequencing: saving a premium death bowler for the final 2 overs vs spreading them is match-defining"
        ]
    },

    # =================================================
    # COACHING / DEVELOPMENT INSIGHTS
    # For development-focused analyses
    # =================================================

    "coaching_context": {
        "batter_development_flags": [
            "Dot ball % > 50%: needs to work on scoring shot selection and footwork",
            "Death SR < 130: needs specific death-hitting practice (yorker, wide yorker, pull shot)",
            "Powerplay SR < 120: consider technique adjustment — trigger movement, back-lift timing",
            "High LBW%: review front-foot movement and bat-pad gap",
            "High caught in outfield%: review shot selection on slow pitches — aerial shots against pace off"
        ],
        "bowler_development_flags": [
            "Death economy > 11: needs specific yorker training and wider yorker control",
            "Powerplay economy > 9: consider line variation — too predictable in length or line",
            "Dot ball% < 35%: needs to develop a wicket-taking delivery — currently too easy to score from",
            "No-ball rate > 2%: serious discipline issue — crease position and run-up review needed",
            "High wide rate in death: pressure is causing bowling width — mental coaching required"
        ],
        "team_balance_flags": [
            "If powerplay SR < 45 RPO: opener selection review needed",
            "If death economy > 11 consistently: dedicated death bowling specialist required",
            "If middle-overs bowling economy > 8.5: spinner quality upgrade needed",
            "If net run rate is dragged down by specific batting position: role clarity needed"
        ]
    }
}